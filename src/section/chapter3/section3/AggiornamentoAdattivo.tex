...
container, incrementato al completamento di ogni richiesta. L'impiego di
operazioni atomiche mantiene questo aggiornamento fuori dal
\emph{critical path} dello scheduler senza introdurre lock.
