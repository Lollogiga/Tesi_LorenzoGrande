...
per ambienti cloud-edge~\cite{Russo2023_Serverledge}, caratterizzata da
un'architettura decentralizzata che consente l'esecuzione di funzioni
serverless all'interno di container.
La piattaforma separa le componenti di
