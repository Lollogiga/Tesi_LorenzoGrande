...
di Serverledge proposta in questa tesi. La valutazione verifica che lo
scheduler carbon-aware traduca la carbon intensity della zona in scelte
coerenti lungo la frontiera di Pareto, modulando il consumo energetico in
funzione dell'impatto carbonico contestuale dell'esecuzione. Il consumo
...
intorno a 1,25~req/s. \emph{Adaptive-ci} evita questo comportamento, mantenendo un throughput
effettivo aderente al profilo configurato in tutte le fasi, con una lieve
divergenza solo nella fase \emph{Peak}. Il risultato indica
