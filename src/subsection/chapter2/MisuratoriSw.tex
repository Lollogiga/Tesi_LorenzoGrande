...
CPU associate a specifici \textit{Control Groups} (cgroups). Tale sottosistema
offre un’interfaccia standard per osservare eventi hardware e software a basso
livello, come cicli di clock, istruzioni eseguite e accessi alla cache, rendendo
possibile una raccolta delle metriche coerente con la granularità richiesta dal
modello di stima. In parallelo, l’HWPC Sensor interroga i \textit{Model Specific Registers}
(MSR)
