...
come quello utilizzato in questo lavoro, Kepler accede direttamente ai 
contatori RAPL, ottenendo misurazioni energetiche real-time senza 
ricorrere a modelli predittivi pre-addestrati. Questo garantisce una 
stima più accurata rispetto agli ambienti virtualizzati, dove l'assenza 
di accesso diretto all'hardware richiede l'uso di modelli di regressione 
con le relative limitazioni di accuratezza.
