...
In un sistema geograficamente distribuito, la carbon intensity, ovvero la
quantità di emissioni di CO\textsubscript{2} associata alla produzione o al
consumo di una determinata quantità di energia elettrica, della rete elettrica
...
carico o sul differimento temporale. Rimane quindi aperta la possibilità di
selezionare, a livello locale, quale implementazione di una funzione eseguire
sul nodo corrente in funzione dell'impatto carbonico corrente e del compromesso
tra energia e qualità.
...
minimo consumo. La valutazione sperimentale su cinque zone
...
costruisce la frontiera di Pareto delle varianti non dominate, ossia quelle per le
quali nessun'altra offre simultaneamente minore consumo e maggiore qualità. Il
...
orientano la selezione verso varianti a basso consumo, valori bassi verso quelle
ad alta accuratezza.
